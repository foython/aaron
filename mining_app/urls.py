...
urlpatterns = [
    ...
    path('average-cycle-time/<int:pk>/', views.average_cycle_time, name='average_cycle_time'),
    path('median-cycle-time/<int:pk>/', views.median_cycle_time_view, name='median_cycle_time_view'),
    path('minimum-cycle-time/<int:pk>/', views.minimum_cycle_time_view, name='minimum_cycle_time_view'),
    ...
    path('average-idle-time/<int:pk>/', views.average_idle_time_view, name='average_idle_time_view'),
    ...
    path('largest-bottleneck/<int:pk>/', views.largest_bottleneck_view, name='largest_bottleneck_view'),
